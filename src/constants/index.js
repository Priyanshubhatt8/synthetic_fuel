...
export const roadmap = [
  ...
  //   text: "Initial Investment: High initial capital investment required for installing wind turbines, solar panels, and energy storage systems. Intermittent Energy Production: Variability in wind and solar energy production due to weather conditions, requiring robust energy management systems.",
  //   date: "May 2023",
  //   status: "progress",
  //   imageUrl: roadmap2,
  // },
  ...
  //   text: "Despite its potential, TC Energy faces many obstacles and threats. Changes in environmental energy policy can significantly affect performance and profitability, increasing regulatory risks. Market risks include volatility in energy prices and demand, which could affect earnings. Environmental risks include reducing the impact of businesses on the environment and achieving sustainability goals. Furthermore, operational risk management is essential to ensure the safety and reliability of major pipelines. Managing these risks requires robust risk management strategies and continued adaptation to the changing regulatory and business environment.",
  //   date: "May 2023",
  //   status: "done",
  //   imageUrl: roadmap3,
  // },
...
export const collabText =
  "The synthetic fuel initiative aims to develop state-of-the-art synthetic fuel production facilities, invest in R&D for advanced synthetic fuel technologies, adapt existing infrastructure for storage and distribution, and establish strategic partnerships with technology providers and renewable energy companies.";
...
export const collabContent = [
  ...
  },
  {
    ...
    text:" Production Facility: Develop a modern synthetic fuel production facility. R&D Investment: Invest in research and development to advance synthetic fuel technologies. Infrastructure Adaptation: Adapt current infrastructure for effective storage and distribution of synthetic fuels.  Strategic Partnerships: Form partnerships with technology providers and renewable energy companies. "
  },
  {
    id: "2",
    title: "SWOT Analysis",
    text:" Strengths: Outstanding financial performance with a record EBITDA of $11 billion in 2023. Extensive and diversified energy infrastructure network. Weaknesses: Risks associated with large-scale, technically complex projects. Revenue limited within North America. Opportunities: Increased market scope by expanding infrastructure on natural gas. Investment in clean energy projects.  Threats:Changing competition and technology. Stricter environmental regulations. "
  },
];
...
export const pricing = [
  {
    id: "0",
    title: "Futureproofing the Business",
    description: "In a rapidly evolving energy market",
    features: [
    "adapting to technological advancements and market.",
    "This initiative ensures that TC Energy remains resilient and agile",
     "capable of responding to future challenges and opportunities. ",
     "By staying ahead of industry trends, ",
     "TC Energy can secure its competitive position and drive sustained growth." 
  ]
    ,
  },
  {
    ...
    features: [
      ...
      "ensuring that the company can reinvest in further ",
      "innovations and improvements.",
      "ensuring stable and sustainable operations."
    ],
  },
  {
    id: "2",
    title: "Driving Long-Term Growth",
    description: "The improvements in production efficiency",
    features: [
      "quality control, and customer engagement create a solid foundation for long-term growth. ",
      "TC Energy can expand its market share and explore ",
      "new business opportunities with the enhanced capabilities ",
      "provided by the transformation. ",
      "This growth ensures the company's continued success and leadership in the energy sector."
    ],
  },
];
